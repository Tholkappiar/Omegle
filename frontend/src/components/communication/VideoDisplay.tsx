...
export const VideoDisplay = ({
    ...
    return (
        <div className="select-none">
            <p className="text-2xl font-DynaPuff text-center bg-gradient-to-r from-purple-500 to-pink-500 bg-clip-text text-transparent mb-4">
                bubbly
            </p>
                ...
                <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-center z-10">
                    ...
                    {videoStates.connection === "left" && (
                        <div className="flex flex-col items-center text-white gap-2 font-light">
                            ...
                            <p>Friend left chat , click next to move ...</p>
                        </div>
                    )}
                </div>
            </div>
